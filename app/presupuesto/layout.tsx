...
export const metadata: Metadata = {
  ...
  description:
    'Calcule el presupuesto orientativo para su reforma de alto standing en Madrid. Estimaciones para reforma integral, interiorismo, cambio de uso y obra nueva.',
  alternates: {
  ...
  openGraph: {
    ...
    description:
      'Obtenga una estimación orientativa para su proyecto de reforma o interiorismo de alto standing en Madrid.',

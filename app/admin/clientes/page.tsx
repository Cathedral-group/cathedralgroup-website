...
export default async function ClientesPage() {
  ...
  const [clientsRes, projectsRes, invoicesRes, communicationsRes] = await Promise.all([
    ...
    supabase.from('invoices').select('id, numero, number, concepto, concept, tipo, direction, total, amount_total, estado, payment_status, proyecto_code, issue_date').is('deleted_at', null).limit(5000),

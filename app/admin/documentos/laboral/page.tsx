...
import { LABORAL_CONFIG } from '../configs'
...
export default async function LaboralPage() {
  ...
  const docTypes = LABORAL_CONFIG.docTypes.map(d => d.value)
  ...
  return <DocumentsView config={LABORAL_CONFIG} initialData={docsRes.data ?? []} projects={projects} />
}

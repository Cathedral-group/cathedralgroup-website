...
import { CORPORATIVO_CONFIG } from '../configs'
...
export default async function CorporativoPage() {
  ...
  const docTypes = CORPORATIVO_CONFIG.docTypes.map(d => d.value)
  ...
  return <DocumentsView config={CORPORATIVO_CONFIG} initialData={docsRes.data ?? []} projects={projects} />
}

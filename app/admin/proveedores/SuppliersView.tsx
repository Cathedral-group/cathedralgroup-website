              ...
              <TabPanel tabs={TABS} activeTab={tab} onTabChange={setTab}>
                {tab === 'datos' && (
                  <div className="space-y-4 pt-4">
                    ...
                    <div><label className={lbl}>Estado</label><select value={form.active === false ? 'inactivo' : 'activo'} onChange={e => set('active', e.target.value === 'activo')} className={inp}><option value="activo">Activo</option><option value="inactivo">Inactivo</option></select></div>

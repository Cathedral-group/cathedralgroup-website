...
// Cuerpo de la página de contacto (cliente, para traducir según la cookie de
      ...
      <section className="pt-16 pb-8 bg-white">
        <div className="max-w-3xl mx-auto px-6 text-center" data-animate="fade-up">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8 py-6 border-t border-b border-neutral-200">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-neutral-400 mb-2">{c('addressLabel')}</p>
              <p className="text-sm">{c('addressLine1')}<br />{c('addressLine2')}</p>
            </div>
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-neutral-400 mb-2">{c('phoneLabel')}</p>
              <p className="text-sm">
                <a href="tel:+34684725606" className="hover:text-primary transition-colors">+34 684 725 606</a>
              </p>
            </div>
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-neutral-400 mb-2">{c('emailLabel')}</p>
              <p className="text-sm">
      ...
      <section className="py-10 bg-beige-subtle">
        <div className="px-6 md:px-10">
          <div className="text-center mb-6">
            <p className="text-xs font-bold uppercase tracking-[0.25em] text-primary mb-2">{c('formEyebrow')}</p>
            <p className="text-sm text-neutral-500">{c('formIntro')}</p>
          </div>

...
// Cuerpo del hub de zonas. 'use client' para leer el idioma (cookie) como el resto
// de secciones traducidas; la página servidora mantiene los metadatos SEO.
export default function ZonasHubContent() {

...
export default function Divisions() {
  ...
  return (
    <section className="bg-beige-subtle" id="servicios">
      {/* Header */}
      <div className="text-center py-16 px-6" data-animate="fade-up">
      ...
      {/* Cards */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 px-6 pb-12" data-animate="stagger">
        {DIVISIONS.map(({ key }) => (
          <div
            key={key}
            className="bg-white p-8 group hover:bg-[#5A5550] transition-all duration-700 premium-transition flex flex-col h-full border border-neutral-100 md:border-0"
          >

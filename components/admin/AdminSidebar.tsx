...
function IconUpload() {
  return <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 flex-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 7.5m0 0L7.5 12M12 7.5v9" /></svg>
}
...
const NAV_SECTIONS_STATIC: NavSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Día, semana, mes, año + accesos cuadrante y Gantt arriba',
      },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: 'Tiempo y permisos legacy',    href: '/admin/personal?seccion=tiempo' },

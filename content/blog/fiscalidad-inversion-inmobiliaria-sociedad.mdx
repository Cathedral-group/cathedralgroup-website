...
- El porcentaje y sus condiciones se han visto afectados por reformas recientes orientadas a zonas tensionadas; antes de aplicar el 60% conviene verificar el supuesto concreto con un asesor.
...
| Reducción vivienda habitual | Sí (60% del rendimiento neto) | No aplica |

...
El marco normativo vigente en Madrid establece tres niveles de autorización para obras, regulados principalmente por la Ordenanza 6/2022 de Licencias y Declaraciones Responsables Urbanísticas del Ayuntamiento de Madrid y el Plan General de Ordenación Urbana (PGOU):
...
**Obras que requieren declaración responsable:**
...
| Aspecto | Detalle |
|---------|---------|
| Plazo de tramitación | 1 - 3 meses (silencio administrativo negativo) |
| Coste en tasas municipales | Tasa urbanística + ICIO (3,75% del PEM) |
...
El Impuesto sobre Construcciones, Instalaciones y Obras (ICIO) es un tributo municipal que grava la realización de cualquier construcción, instalación u obra. En Madrid su tipo impositivo es del 3,75% sobre el coste real y efectivo de la obra (desde el 1 de enero de 2024, Ordenanza Fiscal 7/2023).
...
| Coste en tasas municipales | Tasa urbanística + ICIO (3,75% del PEM) + tasa por licencia urbanística |
...
18. **Informe de evaluación del edificio** (IEE) si el edificio tiene más de 50 años. En Madrid, además, la Inspección Técnica de Edificios (ITE) es obligatoria a los 30 años y se repite cada 10.
...
|-------------------|-------------------|
| Reforma interior sin modificar estructura ni distribución | Ninguno (declaración responsable) |
...
| Distrito | Declaración responsable | Licencia menor | Licencia mayor |
|----------|-------------------|----------------|----------------|
...
|----------|----------|-------------------|
| Leve | Obras menores sin declaración responsable | 600 - 30.000 € |
| Grave | Obras sin licencia menor cuando era exigible | 30.001 - 600.000 € |
| Muy grave | Obras sin licencia mayor, afección a elementos protegidos | 600.001 - 3.000.000 € |
...
- **Imposibilidad de obtener la licencia de primera ocupación** si las obras no están legalizadas.
...
- **Memoria descriptiva**: para declaración responsable.
...
- Declaración responsable: efecto inmediato.
- Licencia menor: silencio administrativo negativo (desestimatorio) tras 1-3 meses.
- Licencia mayor: resolución expresa en 3-6 meses; el silencio administrativo es negativo (desestimatorio) en obra mayor y cambio de uso desde la Ley 1/2020.
